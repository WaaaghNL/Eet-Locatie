<?php
//Config
$MarkdownFile = 'https://raw.githubusercontent.com/WaaaghNL/Restaurant/main/Aanraders.md';
$debug = false;

$cacheInMinutes = 5;
$cacheFile = 'cache-aanraders.json';
            ...
            <div id="main">
                <div id="main-content">
                    ...
                    <div class="content">
                    	...
                    	<h3>Wat is de ELG?</h3>
                    	<p>De eet locatie generator is een project van Waaagh.nl en haalt links uit het overzicht van restaurants die de Smullertjes als aanraders hebben bestempeld! Deze lijst wordt door de dino in een bak met lootjes gegooid en daarna trekt hij er een uit.</p>
                        ...
                        if(!isset($_GET['force'])){
                            ...
                            ?>
                            <p>Onze dino is behoorlijk standvast, als hij iets aanraad gaat hij er ook voor. Het duurt nog <?=$timer;?> secoden voor je hem kan overtuigen voor een nieuw adresje! <a href="<?=$escaped_url;?>aanraders.php?noCache" style="color:#f5f5f5;">Over rule de dino</a></p>
                            <?php
                        }
                        ?>
                    </div>
